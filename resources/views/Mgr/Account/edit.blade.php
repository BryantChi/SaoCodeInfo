    ...
    <div class="col-md-12">
        <form action="" method="post">
            ...
            <div class="form-group">
                <label for="name" class="control-label">信箱 ※</label>
                <input type="email" id="email" name="email" class="form-control" value="{{ $saoadmin_info->email }}" readonly />
            </div>
            <div class="form-group">
                <label for="password" class="control-label">密碼 ※</label>
                <input type="password" id="password" name="password" class="form-control" placeholder="欲變更密碼再輸入新密碼" />
            </div>
            <div class="form-group">
