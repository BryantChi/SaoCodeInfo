...
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    <title>{{ $title or '刀劍神域Alicization Rising Steel－用戶協議&隱私保護聲明' }}</title>
    ...
    <body
        ...
        <div id="header" class="container-fluid m-0 p-0 " style="height:100%;">
            ...
            <nav class="navbar navbar-expand-md navbar-light m-0"
                style="height:180px;width:100%;background-image: url({{URL::asset('img/PC/bg.png')}});background-size: 1300px;background-repeat:no-repeat;/*position:fixed;*/z-index:3">
                <a class="" href="{{ route('Index') }}"><img class="mainlogo" src="{{URL::asset('img/PC/logo.png')}}" alt=""></a>
    
                <button style="display:none!important;" class="navbar-toggler ml-auto mr-1" type="button" data-toggle="collapse"
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03" style="display:none!important;">
                    <ul class="navbar-nav mr-auto mb-5 mt-lg-0 rote" style="z-index:6;">
